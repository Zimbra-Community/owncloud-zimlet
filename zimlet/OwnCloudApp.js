function OwnCloudApp(zimletCtxt, app, settings, davConnector, ownCloudConnector) {
  ...
  app.setContent('<table><tr><td id="WebDAVListView"></td><td><iframe id="WebDAVPreview" src="'+zimletInstance.getConfig("owncloud_zimlet_welcome_url")+'" style="width:'+appWidth/2+'px; height:'+  appHeight +'px; border:0px"></td></tr></table>');
